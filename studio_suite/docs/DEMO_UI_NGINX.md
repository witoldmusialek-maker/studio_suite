...
```powershell
docker compose -f studio_suite/docker-compose.demo-ui.yml up -d
```

## Stop

```powershell
docker compose -f studio_suite/docker-compose.demo-ui.yml down
```
